...
#include "music/note.h"     //!< Inclusion de la structure music_t
...
typedef enum
{
    SEQUENCER_NAV_COL_LINE = 0,   /*!< Colonne du n° de Ligne */
...
typedef struct
{
    ui_seq_nav_col_t col; /*!< Colonne */
    ui_seq_nav_ch_t ch; /*!< Channel */
 ...
 */
int show_sequencer(music_t *music, char *connected);
...
/**
 * \fn void print_sequencer_note(WINDOW *win, note_t note, short ch, int line, ui_seq_nav_t *seqNav, int isCurrLine)
 ...
 */
void print_sequencer_note(WINDOW *win, note_t note, short ch, int line, ui_seq_nav_t *seqNav, int isSelected);

/**
 * \fn void print_sequencer_lines(WINDOW *win, short channelId, music_t *music, ui_seq_nav_t *seqNav)
 ...
 * \see ui_seq_nav_t
 */
void print_sequencer_lines(WINDOW *win, short channelId, music_t *music, ui_seq_nav_t *seqNav);
...
/**
 * @fn void sequencer_nav_up(ui_seq_nav_t *nav)
 * @brief permet de passer d'une ligne à une autre dans le séquenceur
 * @param nav la structure de navigation
 */
void sequencer_nav_up(ui_seq_nav_t *nav, int channelId);

/**
 * @fn void sequencer_nav_down(ui_seq_nav_t *nav)
 * @brief permet de passer d'une ligne à une autre dans le séquenceur
 * @param nav la structure de navigation
 */
void sequencer_nav_down(ui_seq_nav_t *nav, int channelId);

/**
 * @fn void sequencer_nav_left(ui_seq_nav_t *nav)
 * @brief La fonction qui permet de passer d'une colonne à une autre dans le séquenceur (vers la gauche)
 * @param nav la structure de navigation
 */
void sequencer_nav_left(ui_seq_nav_t *nav);

/**
 * @fn void sequencer_nav_right(ui_seq_nav_t *nav)
 * @brief La fonction qui permet de passer d'une colonne à une autre dans le séquenceur (vers la droite)
 * @param nav 
 */
void sequencer_nav_right(ui_seq_nav_t *nav);
 ...
 * @return ui_seq_nav_t 
 */
ui_seq_nav_t create_sequencer_nav(int playMode);

/**
 * @brief create_channel_thread_args(sem_t *syncSem, sem_t *finishSem, ui_seq_nav_t *seqNav, music_t *music, int channel)
 ...
 */
channel_thread_args_t *create_channel_thread_args(sem_t *showSem, sem_t *syncSem, sem_t *finishSem, ui_seq_nav_t *seqNav, music_t *music, int channel);
